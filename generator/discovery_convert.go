...
// This file is adapted from gnostic's conversions/openapiv3.go (Apache 2.0,
// Google LLC). It is vendored here and retargeted to this project's internal
// openapiv3 model so the discovery->OpenAPI conversion does not link
// gnostic-models/openapiv3, whose proto descriptors would collide with
// internal/openapiv3 at registration time. Schema refs are emitted as
// "#/components/schemas/..." to match the generator's resolver.
