...
// Vendored from github.com/google/gnostic/printer.
package printer
...
// Print adds a line of code using the current indentation.
...
// PrintIf adds a line of code if condition is true.
...
// Outdent removes one level of indentation.
func (c *Code) Outdent() {
	c.indent--
	if c.indent < 0 {
		c.indent = 0
